...
describe("Given a set of feature toggles", () => {
    ...
    test("Evaluates to true if feature is contained within the set and enabled", () => {
        var toggles: FeatureToggles = {
            evaluations: [{
                name: "enabledfeature", slug: "enabled-feature", isEnabled: true, segments: {}
            }],
            contentHash: ""
        };
    ...
    test("Evaluates to false if feature is contained within the set but is not enabled", () => {
        var toggles: FeatureToggles = {
            evaluations: [{
                name: "enabledfeature", slug: "enabled-feature", isEnabled: false, segments: {}
            }],
            contentHash: ""
        };
    ...
    describe("When flag key provided is not a slug", () => {
        const toggles: FeatureToggles = {
            evaluations: [{
                name: "notaslug", slug: "not-a-slug", isEnabled: false, segments: {}
            }],
            contentHash: ""
        };
    ...
    describe("When a feature is toggled on for a specific segment", () => {
        const toggles: FeatureToggles = {
            evaluations: [{
                name: "enabledfeature", slug: "enabled-feature", isEnabled: true, segments: { "region": "us" }
            }],
            contentHash: ""
        };
    ...
    describe("When a feature is toggled on for multiple segments", () => {
        const toggles: FeatureToggles = {
            evaluations: [{
                name: "enabledfeature", slug: "enabled-feature", isEnabled: true, segments: { "region": "us", "license": "trial" }
            }],
            contentHash: ""
        };
