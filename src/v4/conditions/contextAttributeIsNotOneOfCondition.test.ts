    ...
    describe("deserialisation", () => {
        ...
        test("Reads an absent key as undefined", () => {
            const condition = parseCondition(
                JSON.parse(`{ "type": "context-attribute-is-not-one-of", "values": ["us"] }`)
            ) as ContextAttributeIsNotOneOfCondition;
        ...
        test("Reads absent values as undefined", () => {
            const condition = parseCondition(
                JSON.parse(`{ "type": "context-attribute-is-not-one-of", "key": "region" }`)
            ) as ContextAttributeIsNotOneOfCondition;
